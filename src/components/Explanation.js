...
import wa from "../imagenes/wa.png"
...
const Explanation = () => {
  ...
  return (  
    <Paper className={classes.explanation} variant="outlined" elevation={0} square>
        ...
        <Typography variant="subtitle1" paragraph gutterBottom style={{margin:"1rem 2rem"}}>
          👉Para el <strong>Segundo Paquete en 15% de descuento</strong>, te presentamos a una computadora promedio que 
       ...
       <br />
           ...
           <img src={wa } alt="wa" className={classes.wa}/>
